$FEAT_4EF = (bd create --title "Feature for 4ef" --type feature --parent gh-toy-4ef --force --silent)
$IMPL_4EF = (bd create --title "Impl 4ef" --type task --parent $FEAT_4EF --force --silent)
$TEST_4EF = (bd create --title "[test] 4ef" --type task --parent $FEAT_4EF --force --silent)
...
$FEAT_7RP = (bd create --title "Feature for 7rp" --type feature --parent gh-toy-7rp --force --silent)
$IMPL_7RP = (bd create --title "Impl 7rp" --type task --parent $FEAT_7RP --force --silent)
$TEST_7RP = (bd create --title "[test] 7rp" --type task --parent $FEAT_7RP --force --silent)
...
$FEAT_MI2 = (bd create --title "Feature for mi2" --type feature --parent gh-toy-mi2 --force --silent)
$IMPL_MI2 = (bd create --title "Impl mi2" --type task --parent $FEAT_MI2 --force --silent)
$TEST_MI2 = (bd create --title "[test] mi2" --type task --parent $FEAT_MI2 --force --silent)

...
parameter. `compose_permissions` must be called before every fleet dispatch,
and a tag switch always requires a fresh dispatch (`resume=false`). See
`docs/pm-tag-dispatch.md` for the full design and invariants.

$IMPL_4EF = bd create --title "Impl: add --version flag to CLI" --type task --silent
$TEST_4EF = bd create --title "[test] add --version flag to CLI" --type task --silent
...
$IMPL_7RP = bd create --title "Impl: help system and input validation" --type task --silent
$TEST_7RP = bd create --title "[test] help system and input validation" --type task --silent
...
$IMPL_MI2 = bd create --title "Impl: CLI CRUD commands" --type task --silent
$TEST_MI2 = bd create --title "[test] CLI CRUD commands" --type task --silent

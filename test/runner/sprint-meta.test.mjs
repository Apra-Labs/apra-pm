...
import { computeSprintAnalysis, computeSprintQuote, DEFAULT_CALIBRATION, MODEL_SONNET, // eslint-disable-next-line no-new-func } from '../../skills/auto-sprint/lib/pure.mjs';
